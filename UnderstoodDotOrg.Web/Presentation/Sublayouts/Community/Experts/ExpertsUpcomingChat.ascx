<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExpertsUpcomingChat.ascx.cs" Inherits="UnderstoodDotOrg.Web.Presentation.Sublayouts.Community.Experts.ExpertsUpcomingChat" %>
<div class="container event">
    <header class="row">
        <div class="event-container skiplink-feature">
            <ul class="breadcrumbs">
                <p>
                    <li><a href="REPLACE">Back to Dolor Maiores</a></li>
            </ul>

            <h2>Chat: <em>Cupiditate Qui Earum</em></h2>
        </div>
    </header>
    ...
    <div class="row">
        <div class="event-container">
            <div class="col-18 col event-content">
                ...
                <p class="event-date-time">Thu May 4 at 12am UTC</p>
                <p class="event-host-name">Dolor Quae Molestias</p>
                <p class="event-host-title">Id Est Quod Nulla Nam</p>
                <p>Eveniet consequatur debitis unde. aut eum mollitia quisquam expedita reiciendis assumenda quibusdam fugiat. animi harum eius beatae eveniet qui autem amet temporibus</p>
...
<div class="container events-chat">
    <div class="row skiplink-content" aria-role="main">
                    ...
                    <div class="event-card-info group">
                        ...
                        <div class="event-card-details">
                            <div class="event-card-datetime">
                                Fri Feb 28 at 12am UTC
                            </div>
                            <!-- end .event-card-datetime -->
                            <div class="event-card-title">
                                <a href="REPLACE">Et Sapiente Ullam Nostrum Velit Sed Aut Facilis Impedit Corporis</a>
                            </div>
            ...
            <div class="col col-11 offset-1 event-cards">
                ...
                <div class="event-card col-22 offset-2">
                    <div class="event-card-info group">
                        ...
                        <div class="event-card-details">
                            <div class="event-card-datetime">
                                Fri Nov 27 at 12am UTC
                            </div>
                            <!-- end .event-card-datetime -->
                            <div class="event-card-title">
                                <a href="REPLACE">Et Excepturi Alias Quia</a>
                            </div>
                            <!-- end .event-card-title -->
                            <p class="event-host-title">vel expedita explicabo molestiae voluptate fugiat</p>
                        </div>
                        <!-- end .event-card-details -->
                    </div>
                    <!-- end .event-card-info -->
        ...
        <a href="REPLACE" class="button see-calendar">See Calendar</a>
    </div>
</div>

<div class="container archive clearfix">
    <div class="row">
            ...
            <div class="event-card">
                <div class="event-card-info group">
                    ...
                    <div class="event-card-details col equalize">
                        <div class="event-card-title">
                            <a href="REPLACE">Libero Alias Ratione Est Enim Quia Incidunt Mollitia Pariatur Incidunt</a>
                        </div>
                        <!-- end .event-card-title -->
                        <p class="event-card-topics-head">Topics Covered</p>
                        <p class="event-card-topics">Distinctio Sit Et Dolor Enim Accusamus Labore Aut Ducimus Esse</p>
                        <span class="children-key">
                            <ul>
                                <li><i class="child-a" title="CHILD NAME HERE"></i></li>
                                <li><i class="child-b" title="CHILD NAME HERE"></i></li>
        ...
        <div class="row">
            <div class="event-card">
                <div class="event-card-info group">
                    ...
                    <div class="event-card-details col equalize">
                        <div class="event-card-title">
                            <a href="REPLACE">Qui Magni Deleniti Harum Dolor Ut Ipsam Laudantium Nobis Natus</a>
                        </div>
                        <!-- end .event-card-title -->
                        <p class="event-card-topics-head">Top Questions</p>
                        <p class="event-card-topics">Tempora Id Consequatur Saepe Est Doloribus Qui Quis Vero Earum</p>
                        <span class="children-key">
                            <ul>
                                <li><i class="child-a" title="CHILD NAME HERE"></i></li>
                                <li><i class="child-b" title="CHILD NAME HERE"></i></li>
    ...
    <div class="row archive-button">
        <a href="REPLACE" class="button see-calendar">See Archive</a>
