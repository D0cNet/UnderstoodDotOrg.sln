...
<div id="community-page" class="whats-happening-page">
    ...
    <sc:Sublayout ID="sbMyGroups" runat="server"  Path="~/Presentation/SubLayouts/Community/Whats Happening/MyGroups.ascx" />
    ...
    <sc:Sublayout ID="sbBlogsIFollow" runat="server" Path="~/Presentation/SubLayouts/Community/Whats Happening/BlogsIFollow.ascx" Visible="false"/>
</div>