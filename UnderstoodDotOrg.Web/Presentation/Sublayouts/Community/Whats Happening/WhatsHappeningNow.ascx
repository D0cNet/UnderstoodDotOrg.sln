<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WhatsHappeningNow.ascx.cs" Inherits="UnderstoodDotOrg.Web.Presentation.Sublayouts.Community.Whats_Happening.WhatsHappeningNow" %>
