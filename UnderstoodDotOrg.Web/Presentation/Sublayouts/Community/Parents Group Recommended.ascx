        ...
        <div class="container rs_read_this parent-groups-recommended-rs-wrapper">
            <header class="groups-heading">
                ...
                <div class="col groups-private">
                    <p class="col">
                        <asp:Literal Text="" ID="litGroupPrivacy" runat="server" />
                    </p>
                    <i class="icon"></i>
                </div>
    ...
    <div class="container show-more rs_skip">
        <div class="row">
            <div class="col col-24">
                <a runat="server" ID="ShowMoreLink" onserverclick="ShowMoreLink_ServerClick" href="#" data-path="community/group-summary" data-container="group-summary-container" data-item="row" data-count="3"><%= UnderstoodDotOrg.Common.DictionaryConstants.ShowMoreLabel %><i class="icon-arrow-down-blue"></i></a>
            </div>
        </div>
    </div>
    <!-- .show-more -->
