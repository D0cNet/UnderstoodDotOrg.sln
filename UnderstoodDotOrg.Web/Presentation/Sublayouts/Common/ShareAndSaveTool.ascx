...
<div class="share-save-container">
  ...
  <div class="share-save-icon">
    ...
    <a href="REPLACE" class="icon icon-share">Share</a><span class="tools">
        <%--<asp:Button ID="btnEmail" runat="server" OnClick="btnEmail_Click" CssClass="icon icon-email" Text="ASPEmail" />--%>
        <%--<a href="../Common/ShareNSave_SendEmail.ascx" class="icon icon-email"   onclick="sendemail()">Email</a>--%>
        <a href="REPLACE" class="icon icon-email"  onclick="javascript:void window.open('~/Presentation/Sublayouts/Common/Sendemail.ascx','1398860309009','width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=0,left=0,top=0');return false;">Email</a>
       <%--  <a href="REPLACE" class="icon icon-email"  onclick="javascript:void window.open('SendEmail','1398860309009','width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=0,left=0,top=0');return false;">Email</a>--%>
      ...
      <input id="hdnBrowser" type="hidden" value=<%=Request.Browser.Browser %>/>
  </div>
</div>
