...
namespace UnderstoodDotOrg.Web.Presentation.Sublayouts.Common {
    public partial class MoreToExplore : System.Web.UI.UserControl {
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (globalItem != null) {
                ...
                if (moreExploreFolder != null) {
                    ...
                    var moreExploreItems = moreExploreFolder.GetMoreExploreItems();
        ...
        protected void rptMoreExplorer_ItemDataBound(object sender, RepeaterItemEventArgs e) {
            if (e.IsItem()) {
                MoreExploreItem exploreItem = e.Item.DataItem as MoreExploreItem;
                if (exploreItem != null) {
                    FieldRenderer frMoreExploreText = e.FindControlAs<FieldRenderer>("frMoreExploreText");
                    if (frMoreExploreText != null) {
                        frMoreExploreText.Item = exploreItem;
                    }
                }
            }
        }
