    ...
    <div id="search-site">
        <fieldset>
            ...
            <span class="field">
                ...
                <input type="submit" value="<%= UnderstoodDotOrg.Common.DictionaryConstants.GoButtonText %>" data-value-default="<%= UnderstoodDotOrg.Common.DictionaryConstants.GoButtonText %>" data-value-medium="<%= UnderstoodDotOrg.Common.DictionaryConstants.SubmitButtonText %>">
            </span>
        </fieldset>
    </div>
    <!-- #search-site -->
