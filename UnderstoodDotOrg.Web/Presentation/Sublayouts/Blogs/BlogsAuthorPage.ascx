    ...
    <div class="container">
            ...
            <div class=" col col-24 blog-featured-author clearfix skiplink-feature">
                <div class="rs_read_this">
                    ...
                    <div class="blog-author-details">
                        <h2>
                            <sc:FieldRenderer ID="BlogBody" runat="server" FieldName="Name" />
                        </h2>
                        <p class="blog-about-author">
                            <sc:FieldRenderer ID="FieldRenderer2" runat="server" FieldName="Biography" />
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-23 blog-post-list-wrapper blog-author-posts clearfix skiplink-content" aria-role="main" aria-role="main">
            <h2 class="rs_read_this">
                <sc:Text Field="Recent Posts Text" runat="server" />
            </h2>
                ...
                <ItemTemplate>
                    <div class="blog-post rs_read_this">
                        <div class="blog-card-image blog-card-total-comments">
                            <a>
                                <sc:Image ID="BlogImg" runat="server" Field="Blog Image"></sc:Image>
                                <%--<img alt="230x129 Placeholder" src="http://placehold.it/230x129" />--%></a>

                        </div>
                        <div class="blog-card-info group">
                            <h3 class="blog-card-title"><a id="hrefBlogLink" runat="server" href="REPLACE">
                                <asp:Literal ID="litBlogPostName" runat="server"></asp:Literal></a></h3>



                            <p class="blog-card-post-excerpt">
                                <asp:Literal ID="litBlogExcerpt" runat="server"></asp:Literal></p>
                        ...
                        <div class="blog-post-timestamp">
                            ...
                            <p class="blog-timestamp-posted">
                                <asp:Literal ID="litBlogPostTime" runat="server"></asp:Literal></p>
                            <p class="blog-time-units">
                                <asp:Literal ID="litBlogAge" runat="server"></asp:Literal></p>
                        </div>
                            ...
                            <div class="col blogger-card">
                                <div class="blogger-card-info group">
                                    <div class="blogger-card-image">
                                        <asp:HyperLink ID="hypAuthorImage" runat="server">
                                            <img alt="150x150 Placeholder" src="http://placehold.it/150x150" />
                                        </asp:Hyperlink>
                                    </div>
                                    <!-- end .blogger-card-image -->
                                    <h4 class="blogger-card-name"><asp:HyperLink ID="hypAuthorName" runat="server"><sc:FieldRenderer ID="frAuthorName" FieldName="Name" runat="server" /></asp:HyperLink></h4>
                                    <!-- end .member-card-name -->
                                </div>
                                <!-- end .blogger-card-info -->
                            </div>
                            <!-- end .blogger-card -->
