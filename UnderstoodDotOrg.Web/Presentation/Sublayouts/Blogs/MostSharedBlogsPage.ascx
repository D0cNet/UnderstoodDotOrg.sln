  ...
  <div class="filters">
    <div class="dropdown">
      <a class="dropdown-toggle" role="button" data-toggle="dropdown" href="#">
          <span class="current-filter"><%= UnderstoodDotOrg.Common.DictionaryConstants.MostSharedLabel %></span>
      ...
      <ul class="dropdown-menu" role="menu">
        ...
        <li role="presentation" class="filter selected" data-sort-by="shared"><a role="menuitem" href="REPLACE"><%= UnderstoodDotOrg.Common.DictionaryConstants.MostSharedLabel %></a></li>
