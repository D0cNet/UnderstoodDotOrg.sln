<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KnowledgeQuizAnswer2ArticlePage.ascx.cs" Inherits="UnderstoodDotOrg.Web.Presentation.Sublayouts.Articles.KnowledgeQuizAnswer2ArticlePage" %>
...
<div class="container article knowledge-quiz-page">
  <div class="row row-equal-heights">
    ...
    <div class="col col-15 offset-1">
      <!-- BEGIN PARTIAL: knowledge-quiz-a13d -->
<div class="knowledge-quiz">
  <div class="question-counter">
    Question 4 of 10
  </div>
  <h3>Which of the following symptoms might signal dyslexia?</h3>
   <p class="correctness-headline"><span class="correct-incorrect incorrect"></span> Incorrect. The answer is&hellip;</p>
  <div class="answer-choices incorrect">
    <ul>
      <li><input type="radio" name="example" checked="checked"><span class="correct-answer-reveal">Trying to solve mysteries, riddles, or crossword puzzles</span></li>
    </ul>
  </div>
  <p class="explanation">Autem nostrum et quia dolor ut dignissimos nihilQuae qui in qui temporibus enim dolorum aperiam deleniti qui quiVelit praesentium necessitatibus et et ipsam et accusamus ut recusandae a veniam debitis veroVoluptas illum est ea <a href="REPLACE">Text link goes here</a> Cupiditate consequuntur praesentium aut reiciendis ducimus commodi quisquam quia soluta illum ut modi repellendusSoluta suscipit sed quod et in dolores et suscipit vitaeNostrum consequatur et quidem suscipit ut aut quo qui utSed optio fugiat ducimus quo aperiam et occaecati aut</p>
  <div class="next-question">
    <button type="button">Next Question</button>
  </div>
</div>
<!-- END PARTIAL: knowledge-quiz-a13d -->
    </div>
