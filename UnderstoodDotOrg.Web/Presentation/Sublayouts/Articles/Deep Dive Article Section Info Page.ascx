<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Deep Dive Article Section Info Page.ascx.cs" Inherits="UnderstoodDotOrg.Web.Presentation.Sublayouts.Articles.Deep_Dive_Article_Section_Info_Page" %>
    ...
    <div class="row row-equal-heights">
        ...
        <div class="col col-15 offset-1">
            ...
            <div class="keep-reading keep-reading-mobile">
                ...
                <ul>
                    <li>
                        <a href="REPLACE">10 Tips to Help Kids Get Organized</a></li>
                    <li>
                        <a href="REPLACE">How to Build a Homework Plan</a></li>
                    <li class="last-child">
                        <a href="REPLACE">Make Space for Learning: The Perfect Study Nook</a></li>
                </ul>
            </div>
