<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KnowledgeQuizAnswerArticlePage.ascx.cs" Inherits="UnderstoodDotOrg.Web.Presentation.Sublayouts.Articles.KnowledgeQuizAnswerArticlePage" %>
...
<div class="container article knowledge-quiz-page">
  <div class="row row-equal-heights">
    ...
    <div class="col col-15 offset-1">
      <!-- BEGIN PARTIAL: knowledge-quiz-a13b -->
<div class="knowledge-quiz">
  <div class="question-counter">
    Question 1 of 10
  </div>
  <h3>True or False? Kids with dyslexia can never learn what other kids learn.</h3>
  <p class="correctness-headline"><span class="correct-incorrect correct"></span> Correct</p>
  <p class="explanation">Non blanditiis harum eveniet qui nesciunt beatae placeat qui laborumDolor quia labore debitis reiciendis et vero voluptatum repellendus natus necessitatibus inventore assumenda maxime asperioresSequi eveniet itaque nobis tenetur deleniti odio ratione dolores hic sedRecusandae voluptas ducimus quo cum officiis omnis <a href="REPLACE">Text link goes here</a> Magni sit veniam magnam harum error porro sit ab perspiciatis et quos beataeAssumenda reiciendis non ea et doloremque quae eius et cum aut dolor quiaLaborum aut repudiandae illo facilisOptio perferendis perferendis excepturi repudiandae</p>
  <div class="next-question">
    <button type="button">Next Question</button>
  </div>
</div>
<!-- END PARTIAL: knowledge-quiz-a13b -->
    </div>
