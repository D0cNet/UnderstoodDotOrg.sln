<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KnowledgeQuizQuestion2ArticlePage.ascx.cs" Inherits="UnderstoodDotOrg.Web.Presentation.Sublayouts.Articles.KnowledgeQuizQuestion2ArticlePage" %>
...
<div class="container article knowledge-quiz-page">
  <div class="row row-equal-heights">
    ...
    <div class="col col-15 offset-1">
      <!-- BEGIN PARTIAL: knowledge-quiz-a13c -->
<div class="knowledge-quiz">
  ...
  <div class="answer-choices">
    <ul>
      <li><label><input type="radio" name="example"> <span>Doing crafts or art projects</span></label></li>
      <li><label><input type="radio" name="example"> <span>Trying to solve mysteries, riddles, or crossword puzzles</span></label></li>
      <li><label><input type="radio" name="example"> <span>Writing a journal or blogging</span></label></li>
      <li><label><input type="radio" name="example"> <span>Reflecting on your life and your future</span></label></li>
    </ul>
  </div>
</div>
<!-- END PARTIAL: knowledge-quiz-a13c -->
    </div>
