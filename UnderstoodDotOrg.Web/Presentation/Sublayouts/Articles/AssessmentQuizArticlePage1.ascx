<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AssessmentQuizArticlePage1.ascx.cs" Inherits="UnderstoodDotOrg.Web.Presentation.Sublayouts.Articles.AssessmentQuizArticlePage1" %>
...
<div class="container assessment-quiz">
  <div class="assessment-quiz-form">
    ...
    <div class="assessment-quiz-pager">Page 1 of 2</div>
    <p class="assessment-quiz-intro">doloremque aut molestiae facere quo repellat commodi soluta iure distinctio natus dicta accusantium nesciunt amet sit autem et ipsa voluptatibus minima magnam ut error possimus</p>
    ...
    <div class="assessment-actions">
      <input class="submit-button assessment-quiz-next" type="submit" value="Next" />
    </div>

  </div><!-- .assessment-quiz-form -->
</div><!-- .assessment-quiz -->
