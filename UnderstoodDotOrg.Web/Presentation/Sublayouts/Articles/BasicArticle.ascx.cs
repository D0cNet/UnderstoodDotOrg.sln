    ...
    public partial class BasicArticle : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ObjBasicArticle != null)
            {
                ...
                litCommentCount.Text = litCommentCount2.Text = CommunityHelper.CommentCount(Convert.ToInt32(ObjBasicArticle.DefaultArticlePage.BlogId.Text), Convert.ToInt32(ObjBasicArticle.DefaultArticlePage.BlogPostId.Text));
