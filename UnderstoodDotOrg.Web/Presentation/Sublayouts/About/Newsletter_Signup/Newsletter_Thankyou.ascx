                ...
                <div class="row">
                    <div class="col col-22 centered rs_read_this email-sign-up-rs-wrapper">
                        ...
                        <header>
                            ...
                            <p>
                                <span class="confirm-title">Your first personalized email should be arriving this week!
    </span>
                                <span class="confirm-description">Don't forget to add <a href="REPLACE">emails@understood.org</a> to your email contacts.
    </span>
                            </p>
                        </header>
