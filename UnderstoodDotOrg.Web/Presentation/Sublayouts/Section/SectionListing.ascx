...
<%@ Register Src="~/Presentation/Sublayouts/Recommendation/ArticleRecommendationIcons.ascx" TagPrefix="uc1" TagName="ArticleRecommendationIcons" %>
                    ...
                    <asp:Repeater runat="server" ID="rptTopicListItems" OnItemDataBound="rptTopicListItems_ItemDataBound">
                        <ItemTemplate>
                            ...
                            <div class="col col-5 offset-1">
                                ...
                                <uc1:ArticleRecommendationIcons runat="server" id="ArticleRecommendationIcons" />
                            </div>
                        </ItemTemplate>
