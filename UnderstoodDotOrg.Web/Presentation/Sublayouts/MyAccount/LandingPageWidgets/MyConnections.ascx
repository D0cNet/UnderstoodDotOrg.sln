    ...
    <div class="landing-modules my-connections">
        ...
        <section class="connections group" id="user_equal_heights">
                    ...
                    <div class="rs_read_this col member-card col-8">
                        <div class="member-card-info group">
                            ...
                            <div class="member-card-name hyphenate member">
                                ...
                                <a href="REPLACE" class="name-member">Cindy7</a>
                                <p class="location">pariatur</p>
                    ...
                    <div class="rs_read_this col member-card col-8">
                        <div class="member-card-info group">
                            ...
                            <div class="member-card-name hyphenate member">
                                ...
                                <a href="REPLACE" class="name-member">Denis34</a>
                                <p class="location">eligendi</p>
            ...
            Boy
                                            ...
                                            <ul>
                                                <li>Quo Et</li>
                                                <li>Excepturi Repellendus</li>
                                                <li>Molestiae Ullam</li>
                                                <li>Eius Sunt</li>
                                            </ul>
                                            <div class="card-buttons">
                                                <button class="button gray">View Profile</button>
                    ...
                    <div class="rs_read_this col member-card col-8">
                        <div class="member-card-info group">
                            ...
                            <div class="member-card-name hyphenate member">
                                ...
                                <a href="REPLACE" class="name-member">Emiliano29</a>
            ...
            Boy
                                            ...
                                            <!-- END PARTIAL: community/carousel_arrows -->
                                            <ul>
                                                <li>Debitis Deleniti</li>
                                                <li>Tempore Qui</li>
                                                <li>Quibusdam Id</li>
                                                <li>Repellat Dolores</li>
                                            </ul>
                                            <div class="card-buttons">
                                                <button class="button gray">View Profile</button>
                                                <button class="button blue">See Activity</button>
