...
<asp:Panel ID="pnlPolulatedNotifs" runat="server">
...
<asp:Panel ID="pnlEmptyNotifs" runat="server">
        <!-- BEGIN PARTIAL: account-notification-tab-notifications-empty -->
        <section class="account-notifications-tab-notifications-empty rs_read_this">
        <p>
            <asp:Literal Text="" ID="litEmptyText" runat="server" /></p>
        </section>

        <!-- END PARTIAL: account-notification-tab-notifications-empty -->
</asp:Panel>
</div>
...
<div class="container show-more rs_skip">
    ...
    <div class="col col-24">
        <a class="show-more-link show_more" href="#" data-path="my-account/notifications" data-container="notification-items-bottom" data-item="notification-item" data-count="2"><%= UnderstoodDotOrg.Common.DictionaryConstants.ShowMoreButtonText %><i class="icon-arrow-down-blue"></i></a>
    </div>
    </div>
</div><!-- .show-more -->
