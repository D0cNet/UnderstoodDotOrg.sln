            ...
            <section class="tech-search-results single">
                ...
                <div class="tech-results-wrapper">
                    <div class="search-result row">
                        <div class="result-image col col-4 offset-1">
                        ...
                        <div class="result-ratings-wrap col col-11 offset-1">
                            <div class="result-ratings ">
                                <div class="result-details">
                                    <div class="result-title">Read Me Stories</div>
                                    <div class="result-description">eum sunt vero iusto ullam aut nobis est voluptas et</div>
