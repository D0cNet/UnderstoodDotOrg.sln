                        ...
                        <div class="result-details col col-7 offset-1">
                            ...
                            <div class="see-rating rs_skip">
                                <div class="popover-trigger-container rs_skip">
                                    <a href="REPLACE" class="popover-link rs_preserve" data-popover-placement="bottom">See Rating</a>
                                </div>
                                <!-- BEGIN PARTIAL: popover-see-rating -->
                                <div class="search-result row popover-container">
                                    <div class="result-image">
...
<asp:Repeater ID="rptrSearchResultsSections" runat="server">
    <ItemTemplate>
        <div class="container select-inverted-mobile<%# Container.ItemIndex % 2 == 0 ? string.Empty : " assistive-tech-results" %>">
            <div class="row">
                <!-- article -->
                <div class="col col-24 instructional skiplink-content" aria-role="main">
                    <!-- BEGIN PARTIAL: tech-search-results -->
                    <section class="tech-search-results multi">
                        <header class="row">
                            <div class="col col-10">
                        ...
                        <footer>
                            ...
                            <div class="container show-more rs_skip">
                                <div class="row">
                                    <div class="col col-24">
                                        <a class="show-more-link " href="#" data-path="assistive-tech/search-results" data-container="at-bottom" data-item="search-results" data-count="0">Show More<i class="icon-arrow-down-blue"></i></a>
                                    </div>
                                </div>
                            </div>
                            <!-- .show-more -->
