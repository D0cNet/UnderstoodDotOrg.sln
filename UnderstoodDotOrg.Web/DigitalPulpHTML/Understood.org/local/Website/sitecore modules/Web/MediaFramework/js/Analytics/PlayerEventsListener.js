...
PlayerEventsListener.prototype = {
    ...
    getContainerParameters: function (args) {
        ...
        if (container != undefined) {
           return $(container).data("mf-params");
        }
        return '';
    },
    ...
    sendEvent: function (eventType,eventArgs, parameters) {
        ...
        parameters = $.extend(parameters || {}, this.getAdditionalParameters(eventArgs));
        ...
        if (Object.getOwnPropertyNames(containerParams).length) {
            parameters = $.extend(parameters, containerParams);
        }
    ...
    getItemId : function () {
        ...
        do {
            ...
            url = w.document.URL;
            hfItemId = $('#MediaFramework_ItemId', w.document);
            w = window.parent;
