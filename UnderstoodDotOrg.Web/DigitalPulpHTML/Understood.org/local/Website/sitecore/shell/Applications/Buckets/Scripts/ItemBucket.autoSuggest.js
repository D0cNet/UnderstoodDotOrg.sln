...
function autoSuggestSlider(filterName, parameters) {
  ...
  if (parameters != "") {
    min         = getGlobalQueryVariable("min", parameters);
    max         = getGlobalQueryVariable("max", parameters);
    range       = getGlobalQueryVariable("range", parameters);
    value       = getGlobalQueryVariable("value", parameters);
    start       = getGlobalQueryVariable("start", parameters);
    end         = getGlobalQueryVariable("end", parameters);
    step        = getGlobalQueryVariable("step", parameters);
...
function autoSuggestDate(filterName, parameters) {
  ...
  //TODO: Language Problem
  if (parameters != "") {
    defaultDate = getGlobalQueryVariable("defaultDate", parameters);
    if (getGlobalQueryVariable("maxDate", parameters) != "") {
      maxDate = getGlobalQueryVariable("maxDate", parameters);
    }

    if (getGlobalQueryVariable("minDate", parameters) != "") {
      minDate = getGlobalQueryVariable("minDate", parameters);
    }

    if (getGlobalQueryVariable("numberOfMonths", parameters) != "") {
      numberOfMonths = getGlobalQueryVariable("numberOfMonths", parameters);
    }

    if (getGlobalQueryVariable("stepMonthsType", parameters) != "") {
      stepMonthsType = getGlobalQueryVariable("stepMonthsType", parameters);
    }
  }
