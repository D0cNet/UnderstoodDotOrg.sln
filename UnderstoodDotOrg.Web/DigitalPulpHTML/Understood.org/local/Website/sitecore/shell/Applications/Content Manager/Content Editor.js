...
scContentEditor.prototype.closeEditorTab = function (id) {
    ...
    if (itemContent.contentWindow.scForm && itemContent.contentWindow.scForm.modified && !confirm(scForm.translate("There are unsaved changes. Are you sure you want to continue?"))) {
        return;
    }
