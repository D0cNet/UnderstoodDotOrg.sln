...
require(["jasmineEnv", "/-/speak/v1/controls/MessageBar.js"], function (jasmineEnv) {
  var setupTests = function (testAreaEl) {
    ...
    describe("Given a messageBar model", function () {
      ...
      describe("when I create a messageBar model", function () {
        ...
        it("it should have an expanded property to be 'true' by default", function () {
          expect(messageBar.get("expanded")).toBe(true);
        });
