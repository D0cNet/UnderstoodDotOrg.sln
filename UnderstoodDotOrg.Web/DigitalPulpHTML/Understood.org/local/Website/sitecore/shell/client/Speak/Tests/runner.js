...
define(["sitecore"], function (Sitecore) {
  return Sitecore.Definitions.App.extend({
    ...
    runJasmine: function () {
      require([
          "/sitecore/shell/client/speak/tests/vendors/jasmine-1.3.1/jasmine.js",
          "/sitecore/shell/client/Speak/Tests/vendors/jquery.mockjax.js"
        ], function () {
          require([
              "/sitecore/shell/client/Speak/Tests/vendors/jquery.mockjax.settings.js",
              "/sitecore/shell/client/speak/tests/vendors/jasmine-1.3.1/jasmine-html.js"], function () {
                ...
                require(["jasmineEnv"], function (jasmineEnv) {
                  window.runTests = function (jasmineEnv, setupTests, testTemplateFileName) {
                    ...
                    var testTemplateFolder = "/sitecore/shell/client/Speak/Tests/renderings/templates/";
