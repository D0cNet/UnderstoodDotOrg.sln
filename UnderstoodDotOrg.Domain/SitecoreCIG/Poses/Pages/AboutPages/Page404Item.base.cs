...
public CustomMultiListField Promo1
{
	get
	{
		return new CustomMultiListField(InnerItem, InnerItem.Fields["Promo 1"]);
	}
}


public CustomTextField PromoHeader
{
	get
	{
		return new CustomTextField(InnerItem, InnerItem.Fields["Promo Header"]);
	}
}


public CustomMultiListField Promo2
{
	get
	{
		return new CustomMultiListField(InnerItem, InnerItem.Fields["Promo 2"]);
	}
}
