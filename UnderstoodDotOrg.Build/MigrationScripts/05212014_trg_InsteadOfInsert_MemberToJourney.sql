USE [UnderstoodQASitecore_membership]
GO

/****** Object:  Trigger [dbo].[trg_InsteadOfInsert_MemberToJourney]    Script Date: 05/21/2014 18:14:43 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[trg_InsteadOfInsert_MemberToJourney]
